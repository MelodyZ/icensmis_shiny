                              ...
                              sidebarPanel(
                                ...
                                div(class = "option-group",
                                    ...
                                    bsPopover("rho", "Proportion of subjects in baseline(reference) group.",
                                              "It ranges from 0 to 1. Move the slider to set a value.", 
                                              "right", options = list(container = "body")),
                                    textInput("pmis", "Pmiss:", 
                                              value = "0"),
                                    bsPopover("pmis", "A value or a vector of the probabilities of each test being randomly missing at each test time.",
                                              "Type in values that must have same length as testtimes, with a comma between each two, i.e. 0.1, 0.2, 0.3, 0.4. If pmiss is a single value, then each test is assumed to have an identical probability of missingness.",
                                              "right", options = list(container = "body")),
                                    textInput("cens", "Pcensor:", 
                                              value = "0"),
                                    bsPopover("cens", "A value or a vector of the probability of censoring at each visit, assuming censoring process is independent on other missing mechanisms.",
                                              "Type in values that must have same length as testtimes, with a comma between each two, i.e. 0.1, 0.2, 0.3, 0.4. If pcensor is a single value, then each test is assumed to have an identical probability of censoring.",
                                              "right", options = list(container = "body")),
